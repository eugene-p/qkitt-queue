...
- Peer dependency `@qkitt/queue` is now `^0.14.0`.

### Added

- Declarative durable retry and observability configuration.
- DLQ `maxHandoffAttempts` forwarding and validation.
- Validation and forwarding for all typed worker options, including timeout
  and tracing context.
